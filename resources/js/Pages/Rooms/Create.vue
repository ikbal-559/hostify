                    ...
                    <form @submit.prevent="submit">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="mb-4">
                                ...
                                <input v-model="form.number" id="number" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.number}" autofocus>
                            ...
                            <div class="mb-4">
                                ...
                                <select v-model="form.room_type_id" id="room_type_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.room_type_id}">
                            ...
                            <div class="mb-4">
                                ...
                                <select v-model="form.availability_status" id="availability_status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.availability_status}">
                            ...
                            <div class="mb-4">
                                ...
                                <select v-model="form.bed_type" id="bed_type" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.bed_type}">
                            ...
                            <div class="mb-4">
                                ...
                                <input v-model="form.number_of_beds" id="number_of_beds" type="number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.number_of_beds}">
                            ...
                            <div class="mb-4">
                                ...
                                <input v-model="form.price_per_night" id="price_per_night" type="number" step="0.01" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.price_per_night}">
                            ...
                            <div class="mb-4">
                                ...
                                <input v-model="form.capacity" id="capacity" type="number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.capacity}">
                            ...
                            <div class="mb-4">
                                ...
                                <input v-model="form.floor" id="floor" type="number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.floor}">
                            ...
                            <div class="mb-4">
                                ...
                                <input v-model="form.room_size" id="room_size" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.room_size}">
                            ...
                            <div class="mb-4">
                                ...
                                <input v-model="form.view" id="view" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.view}">
                            ...
                            <div class="mb-4">
                                ...
                                <input v-model="form.smoking_allowed" id="smoking_allowed" type="checkbox" class="mr-2 leading-tight">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea v-model="form.special_notes" id="special_notes" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.special_notes}"></textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <input @change="handleFileChange" id="thumbnail" type="file" accept="image/*" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" :class="{'border-red-500': form.errors.thumbnail}">
